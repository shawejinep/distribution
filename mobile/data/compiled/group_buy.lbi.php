...
<div class="item_show_box2 box1 region" style="overflow:hidden">
    ...
    <div id="picScroll2" class="picScroll2">
        ...
        <div class="bd1">
            <ul>
                <?php $_from = $this->_var['group_buy_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_80635800_1507270114');$this->_foreach['hot_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hot_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_80635800_1507270114']):
        $this->_foreach['hot_goods']['iteration']++;
?>
                <li><a href="<?php echo $this->_var['goods_0_80635800_1507270114']['url']; ?>"><img src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods_0_80635800_1507270114']['thumb']; ?>" /></a>
                <br/>
                <?php if ($this->_var['goods_0_80635800_1507270114']['promote_price'] != ""): ?> 
                <span class="price_s"> <?php echo $this->_var['goods_0_80635800_1507270114']['promote_price']; ?> </span> 
                <?php else: ?> 
				<font style="font-size:8px">团购价</font><?php echo $this->_var['goods_0_80635800_1507270114']['last_price']; ?>
                
                <?php endif; ?>
                <br><?php echo sub_str(htmlspecialchars($this->_var['goods_0_80635800_1507270114']['goods_name']),12); ?>
                </li>
