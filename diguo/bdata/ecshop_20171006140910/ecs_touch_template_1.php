...
E_D("replace into `ecs_touch_template` values('index','首页促销模块','/library/group_buy.lbi','0','0','3','0','tianxin100','');");
E_D("replace into `ecs_touch_template` values('index','首页促销模块','/library/recommend_promotion.lbi','0','0','6','0','tianxin100','');");
