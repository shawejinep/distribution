...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','甜心100','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','甜心100','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','甜心100','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','甜心100','1');");
E_D("replace into `ecs_shop_config` values('105','1','shop_country','manual','','','1','1');");
E_D("replace into `ecs_shop_config` values('106','1','shop_province','manual','','','11','1');");
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','150','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','甜心100','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','1747602925','1');");
...
E_D("replace into `ecs_shop_config` values('501','5','smtp_host','text','','','localhost','1');");
...
E_D("replace into `ecs_shop_config` values('507','5','mail_service','select','0,1','','0','0');");
...
E_D("replace into `ecs_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:12:{s:6:\"expire\";d:0;s:11:\"expire_unit\";N;s:11:\"separate_by\";i:0;s:15:\"level_point_all\";d:0;s:15:\"level_money_all\";d:0;s:18:\"level_register_all\";i:0;s:17:\"level_register_up\";i:0;s:9:\"parent_id\";s:0:\"\";s:15:\"ex_fenxiao_flag\";s:8:\"delivery\";s:19:\"ex_fenxiao_personal\";s:1:\"1\";s:20:\"level_money_personal\";d:0;s:20:\"level_point_personal\";d:0;}s:4:\"item\";a:3:{i:0;a:2:{s:11:\"level_point\";s:3:\"60%\";s:11:\"level_money\";s:3:\"60%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"30%\";s:11:\"level_money\";s:3:\"20%\";}i:2;a:2:{s:11:\"level_point\";s:2:\"7%\";s:11:\"level_money\";s:2:\"7%\";}}s:2:\"on\";i:1;}','1');");
