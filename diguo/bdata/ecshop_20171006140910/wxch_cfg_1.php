...
E_D("replace into `wxch_cfg` values('2','baseurl','http://shop.ciyin.cc/','yes');");
E_D("replace into `wxch_cfg` values('3','imgpath','local','yes');");
E_D("replace into `wxch_cfg` values('4','plustj','true','yes');");
E_D("replace into `wxch_cfg` values('5','userpwd','mima','yes');");
...
E_D("replace into `wxch_cfg` values('11','q_name','wx-','yes');");
E_D("replace into `wxch_cfg` values('12','tianxin_url','http://mp.weixin.qq.com/s?__biz=MzAwMjcxMDMxMA==&mid=208497323&idx=1&sn=4e195f783557f86e18bf5717288e06e6#rd','yes');");
