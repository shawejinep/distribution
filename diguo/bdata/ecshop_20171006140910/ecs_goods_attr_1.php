...
E_D("replace into `ecs_goods_attr` values('339','163','214','课而我国','0');");
E_D("replace into `ecs_goods_attr` values('340','163','215','代购任何人','0');");
E_D("replace into `ecs_goods_attr` values('341','163','216','跟你ree','0');");
E_D("replace into `ecs_goods_attr` values('342','163','217','where','0');");
E_D("replace into `ecs_goods_attr` values('343','163','218','人为契机','0');");
E_D("replace into `ecs_goods_attr` values('344','163','219','请问','0');");
E_D("replace into `ecs_goods_attr` values('345','163','220','其背后','0');");
E_D("replace into `ecs_goods_attr` values('346','163','221','为别人','0');");
E_D("replace into `ecs_goods_attr` values('347','163','222','吧','0');");
E_D("replace into `ecs_goods_attr` values('348','163','213','金色','11');");
E_D("replace into `ecs_goods_attr` values('349','163','213','黄色','12');");
E_D("replace into `ecs_goods_attr` values('350','163','213','红色','13');");
E_D("replace into `ecs_goods_attr` values('351','163','225','36','12');");
E_D("replace into `ecs_goods_attr` values('352','163','226','白色','1');");
